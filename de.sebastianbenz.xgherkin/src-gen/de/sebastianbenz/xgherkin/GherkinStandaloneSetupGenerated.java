...
public class GherkinStandaloneSetupGenerated implements ISetup {
	...
	public Injector createInjector() {
		return Guice.createInjector(new de.sebastianbenz.xgherkin.GherkinRuntimeModule());
	}
	
	public void register(Injector injector) {
	if (!EPackage.Registry.INSTANCE.containsKey("http://www.sebastianbenz.de/xgherkin/Gherkin")) {
		EPackage.Registry.INSTANCE.put("http://www.sebastianbenz.de/xgherkin/Gherkin", de.sebastianbenz.xgherkin.gherkin.GherkinPackage.eINSTANCE);
	}
